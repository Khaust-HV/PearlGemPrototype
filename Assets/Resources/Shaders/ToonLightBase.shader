 Shader "Lpk/LightModel/ToonLightBase"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_instancing // Enable instancing support
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                float specularNH = smoothstep((1 - specularStep * 0.05)  - specularStepSmooth * 0.05, (1 - specularStep * 0.05)  + specularStepSmooth * 0.05, NH);
                float shadowNL = smoothstep(shadowStep - shadowStepSmooth, shadowStep + shadowStepSmooth, NL);
                ...
                //rim
                float rim = smoothstep((1 - rimStep) - rimStepSmooth * 0.5, (1 - rimStep) + rimStepSmooth * 0.5, 0.5 - NV);
                
                //diffuse
                float3 diffuse = _MainLightColor.rgb * baseMap * baseColor * shadowNL * shadow;
                
                //specular
                float3 specular = specularColor * shadow * shadowNL *  specularNH;
                
                //ambient
                float3 ambient =  rim * rimColor + SampleSH(N) * baseColor * baseMap;
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                o.pos = TransformObjectToHClip(float4(v.vertex.xyz + v.normal * UNITY_ACCESS_INSTANCED_PROP(Props, _OutlineWidth) * 0.1 ,1));
            ...
            {
                float3 finalColor = MixFog(UNITY_ACCESS_INSTANCED_PROP(Props, _OutlineColor), i.fogCoord);
                return float4(finalColor,1.0);
            }
